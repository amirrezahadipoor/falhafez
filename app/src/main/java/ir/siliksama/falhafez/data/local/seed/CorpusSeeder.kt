...
class CorpusSeeder @Inject constructor(
    ...
    /**
     * درجِ یک دسته. به‌جای یک تراکنشِ غول‌آسا برای ۸٬۵۶۵ شعر و ۸۴٬۶۰۶ بیت،
    ...
    companion object {
         ...
         *
         * **هر بار که فایل‌های `.dat` در `assets/corpus/` بازسازی می‌شوند این عدد باید یکی
